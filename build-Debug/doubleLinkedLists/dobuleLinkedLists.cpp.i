# 1 "dobuleLinkedLists.cpp"
# 1 "C:\\Users\\mmohan\\Desktop\\C++Development\\DataStructures\\doubleLinkedLists//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "dobuleLinkedLists.cpp"
# 1 "dobuleLinkedLists.h" 1
...
# 5 "dobuleLinkedLists.h" 2

# 5 "dobuleLinkedLists.h"
using namespace std;
...
public:
    Node(){
        head = 
# 14 "dobuleLinkedLists.h" 3 4
              __null
# 14 "dobuleLinkedLists.h"
                  ;
        tail = 
# 15 "dobuleLinkedLists.h" 3 4
              __null
# 15 "dobuleLinkedLists.h"
                  ;
    }
    void create(int num);
    void display();
...
void Node::create(int num)
{
    ...
    for(int i=0;i<num;i++)
    {
        ...
        if(head==
# 19 "dobuleLinkedLists.cpp" 3 4
                __null
# 19 "dobuleLinkedLists.cpp"
                    )
        {
            head=temp;
            tail=temp;
...
void Node::display()
{
    ...
    cout<<"\nThe Created List is : ";
    while(temp!=
# 39 "dobuleLinkedLists.cpp" 3 4
               __null
# 39 "dobuleLinkedLists.cpp"
                   )
    {
        cin>>temp->data;
        cout<<" ";
